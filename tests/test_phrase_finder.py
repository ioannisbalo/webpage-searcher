...
class TestPhraseFinder(TestCase):
    ...
    def test_find_phrase(self):
        cases = [
            {"phrase": "Chili Piper", "results": [Result(tag="h2", xpath="/html/body/div/div/section[6]/div/div[2]/div[1]/div[1]/h2", string="Chili Piper")]},
            {"phrase": "chili piper", "results": [Result(tag="h2", xpath="/html/body/div/div/section[6]/div/div[2]/div[1]/div[1]/h2", string="Chili Piper")]},
            {"phrase": "veza digital is", "results": [
                Result(tag="div", xpath="/html/body/div/div/section[1]/div[1]/div[6]/div[2]/div[3]/div[2]/div[1]", string="Veza Digital is a full-service growth marketing "),
